...
driver.find_element_by_xpath('//*[@id="login-username"]').send_keys('@gmail.com')   #enter your mail
driver.find_element_by_xpath('//*[@id="login-signin"]').click()
time.sleep(4)
driver.find_element_by_xpath('//*[@id="login-passwd"]').send_keys('5646')     #enter your password
driver.find_element_by_xpath('//*[@id="login-signin"]').click()
time.sleep(3)
